<footer class="page-footer row">
    ...
    <div class="large-6 columns">
        <ul>
            ...
            <li class="footer-spacing">
                <a  href="www.facebook.com"><img src="img/icon/icon-fb" alt="facebook icon"></a>
                <a class="social-spacing" href="www.instagram.com"><img src="img/icon/icon-insta" alt="instagram icon"></a>
                <a class="social-spacing" href="www.twitter.com"><img src="img/icon/icon-twit" alt="twitter icon"></a>
